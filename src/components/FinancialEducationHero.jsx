...
const FinancialEducationHero = () => {
  return (
    <>
    <section className="py-16 px-8 -mt-10 lg:-mt-22 xl:-mt-28 pt-10 lg:pt-32 text-center text-white"
    style={{
        background: 'linear-gradient(107deg, #08A69A 0%, #0ABE9D 54%, #69C9A1 100%)'
      }}>
      <div className="max-w-4xl mx-auto mb-8 ">
        <p className="text-2xl md:text-2xl lg:text-3xl font-light leading-relaxed py-4">
      ...
      <div className="relative overflow-hidden w-full h-32 md:h-32 lg:h-40 flex items-center mt-8">
        ...
        <h2 
          className="absolute whitespace-nowrap text-5xl md:text-6xl lg:text-7xl font-extrabold text-transparent bg-clip-text bg-white/10 stroke-white/80 drop-shadow-md"
          style={{
