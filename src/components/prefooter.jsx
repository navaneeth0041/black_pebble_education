...
const PreFooter = ({
  ...
  return (
<div className="relative px-4 -mt-5 lg:-mt-22 xl:-mt-28 pt-40 md:px-10 py-25 min-h-[70vh] overflow-hidden" style={{ background: 'linear-gradient(90deg, #088F99 0%, #09BE9D 58%, #7ECCA2 88%)' }}>
