    ...
    <div className={`${poppins.className} min-h-screen bg-[#343434] text-white`}>
      ...
      <div className="max-w-4xl mx-auto px-4 pt-2 pb-6">
        <div className="space-y-8 text-sm leading-relaxed">
          ...
          {/* Registration */}
          <div>
            <h2 className="text-lg font-bold mb-4 text-white">Registration</h2>
            <p className="text-gray-300 mb-4">
          ...
          {/* Payment Policy */}
          <div>
            <h2 className="text-lg font-bold mb-4 text-white">Payment Policy</h2>
            <p className="text-gray-300 mb-4">
          ...
          <div>
            <h2 className="text-lg font-bold mb-4 text-white">Fraud and Improper Conduct</h2>
            <p className="text-gray-300 mb-4">
            ...
            <h3 className="text-base font-bold mb-3 text-white">Prohibited Activities</h3>
          ...
          <div>
            <h2 className="text-lg font-bold mb-4 text-white">Permission to Use Information/Materials</h2>
            <p className="text-gray-300 mb-4">
            ...
            <h3 className="text-base font-bold mb-3 text-white">Permitted Use</h3>
            ...
            <h3 className="text-base font-bold mb-3 text-white">Prohibited Use</h3>
            <ul className="text-gray-300 ml-6 space-y-1 mb-4">
          ...
          <div>
            <h2 className="text-lg font-bold mb-4 text-white">Governing Law and Jurisdiction</h2>
            <p className="text-gray-300">
          ...
          {/* General Disclaimer */}
          <div>
            <h2 className="text-lg font-bold mb-4 text-white">General Disclaimer</h2>
            <p className="text-gray-300">
          ...
          <div>
            <h2 className="text-lg font-bold mb-4 text-white">Amendment in Terms of Use</h2>
            <p className="text-gray-300">
