...
export default function WhyChooseUsSection() {
  ...
  return (
    <>
    <div className="bg-[#4598CA] text-white py-8 sm:py-12 md:py-16 lg:py-20 relative overflow-hidden min-h-[60vh] sm:min-h-[70vh] lg:min-h-[80vh] -mt-5 lg:-mt-22 z-50">
    ...
    <img
        ...
        className='w-[200%] block relative -top-2 lg:-top-7 z-50'
      />
    </> 
  );
}