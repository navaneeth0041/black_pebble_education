      ...
      <div className="max-w-7xl w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          <div className="relative flex flex-col items-start">
            ...
            <div className="absolute -top-12 -left-14 sm:-left-18 md:-left-20 lg:-left-24 xl:-left-28 w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-34 lg:h-34 xl:w-42 xl:h-42 z-10 transform -rotate-12">
              <img
            ...
            {/* Main Heading */}
            <h1 
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tight text-teal-500 mb-1 relative z-20"
              style={{ 
            ...
            <h2 
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tight text-teal-500 relative z-20"
              style={{ 
                fontFamily: 'Mochiy Pop One, cursive',
                fontWeight: '400'
              }}
          ...
          <div className="space-y-4 sm:space-y-5 lg:space-y-6">
            ...
            <p 
              className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-teal-500 font-semibold leading-relaxed"
            ...
            {/* Second paragraph */}
            <p 
              className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-teal-500 leading-relaxed"
              style={{ fontFamily: 'Poppins, sans-serif' }}
            >
