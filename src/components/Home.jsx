        ...
        <div className="sm:max-w-md md:max-w-2xl lg:max-w-4xl w-full text-center relative">
          <div className="mb-12 sm:mb-10 md:mb-12">
            <div className="relative inline-block mb-3 sm:mb-6">
              {/* Decorative icons */}
              <div className="hidden sm:block absolute right-3 md:right-3 lg:right-4 bottom-4 md:bottom-6 lg:bottom-8 w-12 h-12 md:w-16 md:h-16 lg:w-20 lg:h-20 xl:w-24 xl:h-24">
                <img src="/home_page_assets/8/Clip path group.svg" alt="Hand Icon" className="w-full h-full object-contain" />
              </div>
              <div className="hidden sm:block absolute left-5 md:left-6 lg:left-7 top-18 md:top-20 lg:top-22 w-12 h-12 md:w-16 md:h-16 lg:w-25 lg:h-20 xl:w-20 xl:h-24">
                <img src="/home_page_assets/8/Group 54.svg" alt="Coins Icon" className="w-full h-full object-contain" />
              </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4 sm:px-0">
            <button
              ...
              className={`${poppins.className} bg-gradient-to-r from-[#08A69A] via-[#0ABE9D] to-[#69C9A1] text-white font-semibold px-6 sm:px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-teal-500/25 w-full sm:w-auto text-sm sm:text-base`}
            >
              Book a Counseling Session
            </button>
            <button
              onClick={onSecondaryClick}
              className={`${poppins.className} bg-transparent border-2 border-white hover:border-gray-400 text-white hover:text-white font-semibold px-6 sm:px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 w-full sm:w-auto text-sm sm:text-base`}
            >
