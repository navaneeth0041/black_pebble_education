    ...
    <section className="py-24 px-4 text-center text-white bg-gradient-to-tr from-[#017a9b] via-[#00b899] to-[#b2e2b4]">
      ...
      <div className="max-w-4xl mx-auto mb-8">
        <p className="text-xl md:text-2xl lg:text-3xl font-light leading-relaxed">
          We ensure your child develops <em className="text-orange-300 font-semibold not-italic">financial knowledge</em>, <em className="text-orange-300 font-semibold not-italic">a financial mindset</em>, and healthy <em className="text-orange-300 font-semibold not-italic">financial behavior</em> so that they not only<br />
